...
ALLOWED_HOSTS = [
    ...
    'localhost',
    '0.0.0.0',
    'https://itsy.pythonanywhere.com/',
    'https://iannico322.github.io/'
...
DATABASES = {
    'default': {
        ...
        'USER':'itsy',
        'PASSWORD':'',
        'HOST':'itsy.mysql.pythonanywhere-services.com',
        'PORT':'3306',
...
DJOSER = {
    ...
    'PASSWORD_RESET_CONFIRM_URL':'itsy-web/reset-password/{uid}/{token}',
    'ACTIVATION_URL': 'itsy-web/activation/{uid}/{token}',
